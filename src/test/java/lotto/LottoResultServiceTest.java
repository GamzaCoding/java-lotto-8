...
public class LottoResultServiceTest {
    ...
    void 총_당첨_금액을_알려준다() {
        //given
        WinningLotto winningLotto = WinningLotto.makeWinningLotto(List.of(10, 20, 30, 40, 44, 45), 1);
        ...
        //when
        long totalLottoWinningAmount = lottoMainService.calculateTotalWinningAmount();
